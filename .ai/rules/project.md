...
- **Releases**: Before tagging, run `./scripts/prepare-release.sh …` (regenerates/validates `CHANGELOG.md`). Release tags push to the GitHub `github` remote for GitHub Releases; collaboration stays on Forgejo `origin`.
