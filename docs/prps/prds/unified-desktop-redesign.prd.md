...
| 4   | Library redesign: cards + inspector rail                                      | Rework `LibraryCard`/`LibraryGrid`/`LibraryToolbar`, add `Inspector.tsx`, register inspector-component contract in `routeMetadata.ts`             | pending | -         | 2, 3    | -        |
| 5   | Hero Detail mode                                                              | New `GameDetail.tsx` (hero + tabs + panel grid); Library ↔ Detail mode toggle; deprecate `GameDetailsModal.tsx`                                   | pending | with 6    | 4       | -        |
