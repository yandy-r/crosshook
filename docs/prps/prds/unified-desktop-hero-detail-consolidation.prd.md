...
| --- | ------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | -------- | ------- | ----------------------------------------------------------------------------------------------------------------- |
| 1   | Hero Detail panel contract expansion + test harness                                  | Extend `HeroDetailPanelsProps` with `profile`, `updateProfile`, `profileList`, `onSetActiveTab`. Thread through `GameDetail` + `HeroDetailTabs`. Add fixtures. No UI change.                  | in-progress | -        | -       | [`hero-detail-panel-contract-phase-1.plan.md`](../plans/hero-detail-panel-contract-phase-1.plan.md)               |
