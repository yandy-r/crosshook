...
| 5b  | Issue follow-ups (#242 / #244 / #245)              | Phase 5 shipped; Phase 5b resolves the open-question issues: Flathub status (not published → keep distro + Faugus link), gamescope→PV teardown fallback by exe-name, Steam-Deck gaming-mode caveats in onboarding.   | in-progress        | -        | 5       | [plan](../plans/umu-migration-phase-5b-issue-followups.plan.md)                                                                                                        |
