...
Primary source root: `src/crosshook-native/`. Release workflows: `.forgejo/workflows/release.yml` (Forgejo) and `.github/workflows/release.yml` (GitHub). Collaboration CI: `.forgejo/workflows/`.
