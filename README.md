...
Contributions are welcome! If you'd like to help improve CrossHook:
- **Bug Reports & Feature Requests:** Please open an [Issue](https://github.com/yandy-r/crosshook/issues).
- **Pull Requests:** Small fixes are welcome anytime. For large features, please open an issue first to discuss the implementation.
- **Development:** Ensure you have the Rust toolchain installed. Run `cargo build` to compile the project locally.
