...
namespace CrossHookEngine.App.Diagnostics
{
    internal static class AppDiagnostics
    {
        ...
        internal static string GetLogFilePath(string appDataRoot = null)
        {
            ...
            return Path.Combine(baseDirectory, "CrossHookEngine", "logs", "crosshook.log");
        }
        ...
        {
            return "CrossHook encountered an unexpected error and needs to close." + Environment.NewLine
                + Environment.NewLine
