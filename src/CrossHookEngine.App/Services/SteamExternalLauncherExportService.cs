...
public static class SteamExternalLauncherExportService
{
    ...
    internal static string BuildTrainerScriptContent(SteamExternalLauncherExportRequest request, string displayName)
    {
        ...
        _ = builder.AppendLine($"# Generated by CrossHook for {displayName}");
    ...
    internal static string BuildDesktopEntryContent(string displayName, string scriptPath)
    {
        ...
        _ = builder.AppendLine($"Name=CrossHook Trainer - {displayName}");
        _ = builder.AppendLine($"Comment=Launch the trainer for {displayName} via Proton");
