...
pub(super) fn fixture() -> RequestFixture {
...
pub(super) fn steam_request() -> (TempDir, LaunchRequest) {
    let RequestFixture {
        _temp_dir,
        game_path,
        trainer_path,
...
pub(super) fn proton_request() -> (TempDir, LaunchRequest) {
...
pub(super) fn native_request() -> (TempDir, LaunchRequest) {
    let (temp_dir, mut request) = steam_request();
