...
pub(super) fn migrate_0_to_1(conn: &Connection) -> Result<(), MetadataStoreError> {
    conn.execute_batch(
        "
...
pub(super) fn migrate_1_to_2(conn: &Connection) -> Result<(), MetadataStoreError> {
    conn.execute_batch(
...
pub(super) fn migrate_2_to_3(conn: &Connection) -> Result<(), MetadataStoreError> {
    conn.execute_batch(
        "
...
pub(super) fn migrate_3_to_4(conn: &Connection) -> Result<(), MetadataStoreError> {
    conn.execute_batch(
        "
...
pub(super) fn migrate_5_to_6(conn: &Connection) -> Result<(), MetadataStoreError> {
    conn.execute_batch(
        "
...
pub(super) fn migrate_7_to_8(conn: &Connection) -> Result<(), MetadataStoreError> {
    let has_column = {
        let mut stmt = conn
...
pub(super) fn migrate_8_to_9(conn: &Connection) -> Result<(), MetadataStoreError> {
    conn.execute_batch(
        "
...
pub(super) fn migrate_9_to_10(conn: &Connection) -> Result<(), MetadataStoreError> {
    conn.execute_batch(
        "
