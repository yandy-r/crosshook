...
export type Capability = {
  ...
  optional_tool_ids: Array<string>;
  missing_required: Array<HostToolCheckResult>;
  missing_optional: Array<HostToolCheckResult>;
  install_hints: Array<HostToolInstallCommand>;
};
 ...
 */
export type HostToolCheckResult = {
  tool_id: string;
  display_name: string;
 ...
 */
export type TrainerGuidanceContent = {
  loading_modes: Array<TrainerGuidanceEntry>;
  trainer_sources: Array<TrainerGuidanceEntry>;
 ...
 */
export type TrainerGuidanceEntry = {
  id: string;
  title: string;
  description: string;
  when_to_use: string;
