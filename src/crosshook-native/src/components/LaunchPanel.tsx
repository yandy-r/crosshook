  ...
  return (
    <section style={panelStyles.card}>
        <div style={{ display: "flex", justifyContent: "space-between", gap: "16px", alignItems: "start", flexWrap: "wrap" }}>
          <div>
            <p style={{ margin: 0, textTransform: "uppercase", letterSpacing: "0.18em", color: "#7bb0ff", fontSize: "0.74rem" }}>
              Steam Launch
            </p>
        ...
        <div style={{ marginTop: "24px", padding: "18px", borderRadius: "16px", background: "rgba(7, 12, 24, 0.55)", border: "1px solid rgba(255, 255, 255, 0.07)" }}>
        ...
        <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", marginTop: "22px" }}>
          <button
            ...
            style={{
              ...
              background: !canLaunch || isBusy ? "rgba(123, 176, 255, 0.18)" : "linear-gradient(135deg, #2f7cf6 0%, #5ac8fa 100%)",
              color: "#fff",
              fontSize: "1rem",
              fontWeight: 700,
        ...
        <div style={{ marginTop: "22px", display: "grid", gap: "10px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", color: "#9fb1d6" }}>
            <span style={{ width: "10px", height: "10px", borderRadius: "50%", background: isSessionActive ? "#27d17f" : isWaitingForTrainer ? "#f5c542" : "#5e77ff" }} />
